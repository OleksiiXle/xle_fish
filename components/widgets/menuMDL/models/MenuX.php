...
namespace app\components\widgets\menuMDL\models;
...
class MenuX extends \yii\db\ActiveRecord{
    ...
    public static function getTree($tree, $pid){
        ...
        foreach ($tree as $row) {
            if ($row['parent_id'] == $pid) {
                ...
                if ($hasChildren){
                     ...
                     */
                    $content = '<a class="node mdl-navigation__link" '
                    ...
                    $content = Html::a(\Yii::t('app', $row['name']), Url::to($row['route'], true),
                        [
                            'class' => 'route mdl-navigation__link',
                        ]);
                }
                $html .= '<li>'
                    . $content
        ...
        return $html ? '<ul class="ulMenuX ' . $uStyle . '" style="">' . $html . '</ul>' : '';
    }
